      ...
      <AnimatePresence>
        {open && (
          <motion.p
            ...
            className="overflow-hidden text-gray-500 text-sm md:text-base leading-relaxed pr-4 md:pr-8"
          >
            {answer}
          </motion.p>
        )}
...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="w-full bg-white py-12 md:py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            variants={fadeRight}
          >
            <h2 className="text-3xl md:text-4xl font-black tracking-tight text-[#1b2a52] leading-tight mb-4 text-center md:text-left">
              We are leading <span className="text-[#F27A22]">manufacturers of FRP</span> in{" "}
              <span className="text-[#1b2a52]">Hyderabad – India.</span>
            </h2>
            <p className="text-gray-500 text-sm md:text-base leading-relaxed mb-8 text-center md:text-left">
            ...
            <ul className="space-y-3 mb-8">
              {["Advanced Vacuum Infusion Technology", "In-house R&D and Tooling Facility", "End-to-end Project Management"].map((item) => (
                <li key={item} className="flex items-center gap-3 justify-center md:justify-start">
                  ...
                  <span className="font-semibold text-[#1b2a52] text-sm md:text-base">{item}</span>
                </li>
              ))}
            </ul>
            <div className="text-center md:text-left">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-[#F27A22] text-white px-8 py-3 rounded font-bold text-sm md:text-base hover:bg-[#c96414] transition-colors w-full sm:w-auto"
              >
                Read More
              </motion.button>
            </div>
          ...
          >
            <div className="absolute -top-3 -left-1 md:-top-4 md:-left-4 w-16 h-16 md:w-24 md:h-24 border-t-[3px] border-l-[3px] border-[#F27A22]" />
            ...
            <motion.div
              ...
              // Adjusted positioning for mobile so it doesn't overflow
              className="absolute -bottom-6 -right-2 md:-bottom-8 md:-right-6 bg-[#1b2a52] text-white p-4 md:p-6 rounded-xl shadow-xl z-20 text-center min-w-[140px] md:min-w-[180px]"
            >
              <span className="text-3xl md:text-4xl font-black">#1</span>
              <p className="text-[10px] md:text-sm font-bold tracking-widest uppercase mt-1">Composite Partner</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      {/* ── INDUSTRIES WE SERVE ─────────────────────────────────────────── */}
      <section className="w-full bg-slate-50 py-12 md:py-20 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <h2 className="text-3xl md:text-[38px] font-black text-[#1b2a52]">
              ...
              <span className="text-[#F27A22] hidden sm:inline">——</span>
            </h2>
          ...
          >
            {industries.map(({ icon: Icon, label, desc }, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="flex flex-col sm:flex-row gap-4 items-center sm:items-start text-center sm:text-left p-6 sm:p-5 border border-gray-200 bg-white rounded-xl hover:shadow-md transition-shadow"
              >
                <div className={`shrink-0 w-14 h-14 rounded-lg flex items-center justify-center ${i % 2 === 0 ? "bg-[#F27A22]" : "bg-[#1b2a52]"}`}>
                  <Icon className="w-7 h-7 text-white" />
                </div>
                <div className="mt-2 sm:mt-0">
                  <h3 className="font-black text-[#1b2a52] text-base md:text-lg mb-1.5 sm:mb-1">{label}</h3>
      ...
      {/* ── OUR PRODUCTS ────────────────────────────────────────────────── */}
      <section className="w-full bg-white py-12 md:py-20 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-[#1b2a52]">
              Our <span className="italic text-[#F27A22]">Products</span>{" "}
              <span className="text-[#F27A22] hidden sm:inline">——</span>
            </h2>
            <p className="text-gray-500 text-sm md:text-lg leading-relaxed mt-4 max-w-2xl mx-auto">
          ...
          >
            {[
              ...
              >
                <div className="h-[200px] md:h-[220px] overflow-hidden bg-gray-50 flex items-center justify-center">
                  <motion.img
                    whileHover={{ scale: 1.05 }}
                ...
                <div className="p-5 md:p-6 text-center sm:text-left">
                  <h3 className="text-lg md:text-[22px] font-black text-[#1b2a52] mb-2 leading-tight">{title}</h3>
                  <p className="text-[#F27A22] text-sm md:text-base font-semibold leading-relaxed">{desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="w-full bg-[#111827] py-16 md:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <motion.div
            ...
            variants={fadeRight}
          >
            <h2 className="text-3xl md:text-[38px] font-black text-white mb-2 text-center md:text-left">
              Why choose <span className="italic text-[#F27A22]">us</span>{" "}
              <span className="text-[#F27A22] hidden sm:inline">——</span>
            </h2>
            <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-8 max-w-sm mx-auto md:mx-0 text-center md:text-left">
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={fadeUp}
                className="bg-[#1e293b] border border-gray-700 rounded-xl p-6 hover:border-[#F27A22] transition-colors flex flex-col items-center sm:items-start text-center sm:text-left"
              >
                <div className="w-11 h-11 bg-[#F27A22]/10 rounded-lg flex items-center justify-center mb-4">
                  <Icon className="w-5 h-5 text-[#F27A22]" />
                </div>
                <h4 className="font-bold text-white text-sm md:text-base mb-2">{label}</h4>
      ...
      {/* ── OUR UNIQUE PRODUCT ──────────────────────────────────────────── */}
      <section className="w-full bg-slate-50 py-12 md:py-20 border-b border-gray-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="w-16 h-1 bg-[#F27A22] mb-6 rounded-full mx-auto lg:mx-0" />
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-[#1b2a52] text-white px-8 py-3 rounded font-bold text-sm md:text-base hover:bg-[#F27A22] transition-colors w-full sm:w-auto"
            >
              Learn More
            </motion.button>
          </motion.div>
          ...
          >
            <img src="/loadtestingbox.png" alt="Unique Product" className="w-full max-w-sm md:max-w-md h-auto object-contain drop-shadow-xl" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="w-full py-0 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeRight}
            className="bg-white px-6 py-12 md:px-16 md:py-20"
          >
            <h2 className="text-2xl md:text-3xl font-black text-[#1b2a52] mb-2 text-center md:text-left">
              Learn more from our{" "}
              <span className="italic text-[#F27A22]">FAQ</span>
            </h2>
            <div className="w-12 h-1 bg-[#F27A22] mb-6 rounded-full mx-auto md:mx-0" />
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeLeft}
            className="bg-[#f8f9fb] px-6 py-12 md:px-16 md:py-20 border-t lg:border-t-0 lg:border-l border-gray-200"
          >
            <h2 className="text-2xl md:text-3xl font-black text-[#1b2a52] mb-2 text-center md:text-left">Get In Touch</h2>
            <div className="w-12 h-1 bg-[#F27A22] mb-6 rounded-full mx-auto md:mx-0" />
            <div className="space-y-4">
              {[
                ...
                <div key={label}>
                  <label className="block text-xs md:text-sm font-bold text-gray-600 mb-1 uppercase tracking-wide">{label}</label>
                  <div className="relative">
                    <Icon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                    <input
                      type={type}
                      placeholder={placeholder}
                      className="w-full border border-gray-200 rounded-lg pl-9 pr-4 py-2.5 text-sm md:text-base focus:outline-none focus:border-[#F27A22] bg-white transition-colors"
                    />
                  </div>
                </div>
              ))}
              <div>
                <label className="block text-xs md:text-sm font-bold text-gray-600 mb-1 uppercase tracking-wide">Message</label>
                <div className="relative">
                  <MessageSquare className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                  <textarea
                    rows={4}
                    placeholder="Tell us about your project..."
                    className="w-full border border-gray-200 rounded-lg pl-9 pr-4 py-2.5 text-sm md:text-base focus:outline-none focus:border-[#F27A22] bg-white resize-none transition-colors"
                  />
                </div>
              </div>
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-[#F27A22] text-white py-3 md:py-4 rounded-lg font-bold text-sm md:text-base hover:bg-[#c96414] transition-colors"
              >
                Send Message
              </motion.button>
            </div>
      ...
      <section className="w-full bg-[#111827] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-gray-400 text-sm md:text-base text-center mb-10 md:mb-12">
          ...
          >
            {testimonials.map(({ name, role, text }) => (
              <motion.div
                key={name}
                variants={fadeUp}
                className="bg-[#1e293b] border border-gray-700 rounded-xl p-6 md:p-7 hover:border-gray-500 transition-colors"
              >
                ...
                <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-6 text-center sm:text-left">"{text}"</p>
                <div className="flex items-center gap-3 justify-center sm:justify-start">
                  <div className="w-10 h-10 bg-[#F27A22]/20 rounded-full flex items-center justify-center shrink-0">
                    <User className="w-5 h-5 text-[#F27A22]" />
                  </div>
                  <div className="text-left">
                    <p className="text-white font-bold text-sm md:text-base">{name}</p>
                    <p className="text-gray-500 text-xs md:text-sm uppercase tracking-wide mt-0.5">{role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="w-full bg-white py-12 md:py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            variants={fadeUp}
          >
            <h2 className="text-2xl md:text-3xl font-black text-[#1b2a52] text-center mb-2">
              Factory <span className="italic text-[#F27A22]">Video</span> gallery
            </h2>
            <div className="w-16 h-1 bg-[#F27A22] mx-auto mb-10 md:mb-12 rounded-full" />
          </motion.div>
          ...
          >
            {["/bus.png", "/robot.png", "/bus2.png"].map((src, i) => (
              ...
              >
                <img src={src} alt={`Gallery ${i + 1}`} className="w-full h-[200px] object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/50 transition-colors">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    className="w-12 h-12 md:w-14 md:h-14 bg-[#F27A22] rounded-full flex items-center justify-center shadow-lg"
                  >
                ...
                {i === 1 && (
                  <div className="absolute top-3 left-3 bg-[#F27A22] text-white text-xs md:text-sm font-bold px-2 py-1 rounded uppercase tracking-wide">
                    Painting Section
                  </div>
                )}
              </motion.div>
      ...
      <section className="w-full bg-slate-50 py-12 md:py-20 overflow-hidden relative border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center mb-8 md:mb-12">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.2 }}
            variants={fadeUp}
          >
            <h2 className="text-2xl md:text-3xl font-black text-[#1b2a52] mb-2">
        ...
        <div className="relative flex overflow-x-hidden group">
          ...
          <div className="absolute top-0 bottom-0 left-0 w-12 md:w-32 bg-gradient-to-r from-slate-50 to-transparent z-10 pointer-events-none" />
          <div className="absolute top-0 bottom-0 right-0 w-12 md:w-32 bg-gradient-to-l from-slate-50 to-transparent z-10 pointer-events-none" />

          {/* Render 2 identical motion divs side-by-side to create a seamless loop */}
          <motion.div
            className="flex items-center gap-4 md:gap-10 pr-4 md:pr-10 w-max"
            animate={{ x: ["0%", "-100%"] }}
          ...
          >
            {clientsList.map(({ src, alt }, idx) => (
              <div
                key={`${alt}-${idx}`}
                className="w-40 md:w-56 h-24 md:h-28 shrink-0 flex items-center justify-center rounded-xl md:rounded-2xl bg-white px-4 md:px-6 py-4 md:py-5 cursor-pointer border border-gray-100 shadow-sm transition-all duration-300 hover:border-orange-200 hover:-translate-y-1 hover:shadow-md"
              >
                <Image
                  src={src}
                  alt={alt}
      ...
      <section className="w-full bg-white py-16 md:py-20 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <p className="text-gray-500 text-sm md:text-base mb-12 md:mb-16">How we turn concepts into high-performance composites</p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={staggerContainer}
              // Uses grid-cols-1 on mobile, 2 on tablet, 5 on desktop
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-4"
            >
              {[
                ...
                <motion.div key={i} variants={fadeUp} className="flex flex-col items-center">
                  <div className={`w-16 h-16 md:w-20 md:h-20 bg-white rounded-full border-2 ${i === 0 ? "border-[#F27A22]" : "border-blue-200"} flex items-center justify-center mb-4 md:mb-5 shadow-sm`}>
                    <span className="text-xl md:text-2xl font-black text-[#1b2a52]">{step.num}</span>
                  </div>
                  <h4 className="text-xs md:text-sm font-black tracking-widest text-[#1b2a52] mb-1 md:mb-2 uppercase">{step.title}</h4>
                  <p className="text-gray-500 text-xs md:text-sm px-2 md:px-4">{step.desc}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
      ...
      {/* ── CTA ──────────────────────────────────────────────────────────── */}
      <section className="w-full bg-[#1b2a52] py-16 md:py-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        ...
        >
          ...
          <p className="text-blue-200 text-sm md:text-lg max-w-2xl mx-auto mb-8 md:mb-10">
            Get in touch with our engineering team for custom quotes and technical feasibility studies.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-[#F27A22] text-white px-8 md:px-12 py-3 md:py-4 rounded font-bold text-sm md:text-base hover:bg-[#c96414] transition-colors shadow-lg shadow-black/20 w-full sm:w-auto"
          >
            Request a Quote
          </motion.button>
        </motion.div>
